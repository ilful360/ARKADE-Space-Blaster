...
A retro-styled browser space shooter built with **React, TypeScript, Vite, and handcrafted CSS**.
...
- TypeScript
- Vite
- Centralized CSS animations, effects, responsive layout, and visual styling
